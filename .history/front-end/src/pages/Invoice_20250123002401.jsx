                                                    ...
                                                    <table className="tm_mb15">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td className="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_primary_color tm_text_right tm_gray_bg tm_radius_0_6_6_0">{(parseInt(food) + parseInt(otheres) + parseInt(getInvoice.room_price)) - parseInt(discount)} </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
