                                                    ...
                                                    <table className="tm_mb15  ">
                                                        <tbody>
                                                            <tr className='tm_gray_bg  costom_border_clr  '>
                                                                <td className="tm_width_3 tm_danger_color tm_f16 tm_pt1  ">Sub Total (৳)</td>
                                                                <td id='subTotalUpdate' className="tm_width_3 tm_danger_black tm_f18 tm_text_right tm_border_none tm_pt1 border">
                                                                   {getInvoice.extra_5}
                                                                </td>
                                                            </tr>
