...
const Booking = () => {
    ...
    const onSubmit = (dataArray) => {
        ...
        // Check if the incoming data is an array (handle multiple bookings)
        ...
        dataArray.forEach((data, index) => {
            ...
            if (data.nid_doc?.[0]) formData.append(`bookings[${index}][nid_doc]`, data.nid_doc[0]);
            if (data.couple_doc?.[0]) formData.append(`bookings[${index}][couple_doc]`, data.couple_doc[0]);
            if (data.passport_doc?.[0]) formData.append(`bookings[${index}][passport_doc]`, data.passport_doc[0]);
            if (data.visa_doc?.[0]) formData.append(`bookings[${index}][visa_doc]`, data.visa_doc[0]);
            if (data.other_doc?.[0]) formData.append(`bookings[${index}][other_doc]`, data.other_doc[0]);
        });
